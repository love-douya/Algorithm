# 1 "Dijkstra_Matrix.cpp"
# 1 "C:\\Users\\TAO\\Desktop\\Algorithm\\Dijkstra//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Dijkstra_Matrix.cpp"
...
# 2 "Dijkstra_Matrix.cpp" 2
# 1 "c:\\mingw\\include\\limits.h" 1 3
# 26 "c:\\mingw\\include\\limits.h" 3
       
# 27 "c:\\mingw\\include\\limits.h" 3
# 3 "Dijkstra_Matrix.cpp" 2
...
# 9 "Dijkstra_Matrix.cpp"
int minDistance(int dist[], bool sptSet[]){
        int min = 
# 10 "Dijkstra_Matrix.cpp" 3
                 2147483647
# 10 "Dijkstra_Matrix.cpp"
                        , min_index;
        for (int v = 0; v < 9; v++){
...
void dijkstra(int graph[9][9], int src){
    ...
    for (int i = 0; i < 9; i++)
        dist[i] = 
# 36 "Dijkstra_Matrix.cpp" 3
                 2147483647
# 36 "Dijkstra_Matrix.cpp"
                        , sptSet[i] = false;
...
# 51 "Dijkstra_Matrix.cpp" 3
                                                       2147483647
            
# 52 "Dijkstra_Matrix.cpp"
